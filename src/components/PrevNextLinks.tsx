    ...
    <div {...props}>
      ...
      <dd className="mt-1">
        <Link
          to={href}
          className={clsx(
            'flex items-center gap-x-1 text-base font-semibold text-zinc-500 hover:text-zinc-600 dark:text-zinc-400 dark:hover:text-zinc-300',
...
export function PrevNextLinks() {
  let pathname = useLocation({ select: (location) => location.pathname })
