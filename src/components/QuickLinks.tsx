...
export function QuickLink({
  ...
  return (
    <div className="group relative rounded-xl border border-zinc-200 dark:border-zinc-800">
      <div className="absolute -inset-px rounded-xl border-2 border-transparent opacity-0 [background:linear-gradient(var(--quick-links-hover-bg,var(--color-teal-50)),var(--quick-links-hover-bg,var(--color-teal-50)))_padding-box,linear-gradient(to_top,var(--color-indigo-400),var(--color-cyan-400),var(--color-teal-500))_border-box] group-hover:opacity-100 dark:[--quick-links-hover-bg:var(--color-zinc-800)]" />
